-- ===========================================
-- CLINIC COPILOT - DATABASE SCHEMA
-- ===========================================
-- Deploy this schema to Supabase SQL Editor
-- ===========================================
...
CREATE TABLE public.profiles (
    ...
    -- Note: self_patient_id is for 'member' role users who ARE their own patient
...
-- ============================================
-- USAGE EVENTS (for WS-5 Analytics)
-- ============================================
...
-- Indexes for usage_events (WS-5 will query these)
...
-- ============================================
-- SEED OMINOUS MARKERS (7 critical markers)
-- ============================================
