-- Lower similarity threshold from 0.6 to 0.5 to capture more relevant results
-- Evidence: successful searches have similarity 0.54-0.58, many queries just miss 0.6
-- Also adds multi_system to body system filter to include cross-system documents
...
CREATE OR REPLACE FUNCTION public.bfm_search_20250122(
    ...
    p_match_threshold DOUBLE PRECISION DEFAULT 0.45,  -- Changed from 0.6
